            ...
            <ul class="site-menu js-clone-nav d-none d-lg-block">
              ...
              <li class="has-children">
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="service-single.blade.php" class="active">Service Single</a></li>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mx-auto w-75">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia consectetur doloribus molestiae quibusdam similique.</p>
            </div>
          </div>
        </div>
      </div>
