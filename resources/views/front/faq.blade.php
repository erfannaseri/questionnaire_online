...
<div class="site-wrap">
    ...
    <header class="site-navbar mt-3" id="top">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="index.blade.php">Scenic</a></div>
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-lg-block">
              ...
              <li class="has-children">
                <a href="services.blade.php" class="active">Pages</a>
                <ul class="dropdown">
                  ...
                  <li><a href="faq.blade.php" class="active">Frequently Ask Questions</a></li>
    ...
    <section class="home-section section-hero overlay slanted" id="home-section">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mx-auto w-75">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque maiores ab minima rem Sunt</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <a href="#accordion" class="smoothscroll scroll-button">
      ...
      <div class="container">
        ...
        <div class="row accordion block__76208">
          <div class="col-lg-6">
            ...
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false" aria-controls="collapseSix">How much pay for 3  months?<span class="icon"></span></a>
              </h3>
          ...
          <div class="col-lg-6 ">
            <!-- <div class=""> -->
              <div class="accordion-item">
                <h3 class="mb-0 heading">
                  <a class="btn-block" data-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false" aria-controls="collapseOne">What is the name of your company<span class="icon"></span></a>
                </h3>
