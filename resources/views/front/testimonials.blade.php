            ...
            <ul class="site-menu js-clone-nav d-none d-lg-block">
              ...
              <li class="has-children">
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="testimonials.blade.php" class="active">Testimonials</a></li>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mx-auto w-75">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, natus soluta atque enim quo.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12 mb-4">
            <div class="block__87154 bg-primary">
              <span class="quote"><img src="images/quote.png" alt="Image"></span>
              <blockquote>
                <p class="text-white">Ipsum harum assumenda in eum vel eveniet numquam, cumque vero vitae enim cupiditate deserunt eligendi officia modi consectetur. Expedita tempora quos nobis earum hic ex asperiores quisquam optio nostrum sit</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img src="images/person_4.jpg" alt="Image" class="img-fluid"></figure>
                <div>
