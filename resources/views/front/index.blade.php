        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-lg-block">
              <li><a href="index.blade.php" class="nav-link active">Home</a></li>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <p class="mt-5"><a href="contact.blade.php" class="btn btn-outline-white btn-md ">Get in touch</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.blade.php" class="block__16443 text-center d-block">
      ...
      <div class="container">
        ...
        <div id="posts" class="row no-gutter">
          <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
            <a href="portfolio-single.blade.php" class="item-wrap">
      ...
      <div class="container">
        ...
        <div class="row text-center">
          <div class="col-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> | تمامی حقوق ناشر محفوظ است<i class="icon-heart text-danger" aria-hidden="true"></i>
                    <br><a href="https://colorlib.com" target="_blank" >Erfan</a>طراحی قالب توسط
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </small></p>
          </div>
        </div>
